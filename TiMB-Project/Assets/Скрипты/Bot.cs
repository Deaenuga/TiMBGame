...
public class Bot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(lang=="ru")
        countLetters = string.Join(" ", FindObjectOfType<CreatePlatformWithLetters>().letters[PlayerPrefs.GetInt("currLevelRu")]).Length;
        else
        countLetters = string.Join(" ", FindObjectOfType<CreatePlatformWithLetters>().letters[PlayerPrefs.GetInt("currLevelEng")]).Length;
