...
public class DailyBonus : MonoBehaviour
{
    ...
    {
        PlayerPrefs.SetInt("FirstTimeRu", 0);
        PlayerPrefs.SetInt("FirstTimeEng", 0);
        ...
        PlayerPrefs.SetInt("LocationNumRu", 0);
        PlayerPrefs.SetInt("LocationNumEng", 0);
        PlayerPrefs.SetInt("currLevelRu", 0);
        PlayerPrefs.SetInt("currLevelEng", 0);
        PlayerPrefs.SetInt("Coins", 0);
        PlayerPrefs.SetInt("Dollar", 0);
        PlayerPrefs.SetInt("levelNumRu", 1);
        PlayerPrefs.SetInt("levelNumEng", 1);
        PlayerPrefs.SetInt("FirstStart", 1);
